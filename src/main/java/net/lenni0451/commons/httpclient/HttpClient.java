...
public class HttpClient extends HeaderStore<HttpClient> implements HttpRequestBuilder {
     ...
     */
    public HttpClient(@NotNull final Function<HttpClient, RequestExecutor> executorSupplier) {
     ...
     */
    public HttpClient setExecutor(@NotNull final Function<HttpClient, RequestExecutor> executorSupplier) {
